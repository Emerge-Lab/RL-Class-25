...
## Tips
- The `gather()` function or fancy indexing is essential for selecting Q-values of specific actions from a Q-value table
...
This propagates reward information n steps backward in a single update, dramatically improving credit assignment for environments with delayed rewards. It incurs increased variance but can still be worth it and is a common tuning parameter.
